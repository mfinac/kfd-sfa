...
import com.datamation.kfdupgradesfa.helpers.IResponseListener;
        ...
        lvCustomers.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view2, int position, long id) {
                ...
                if (i > 0) {
                    ...
                    String status = debtor.getFDEBTOR_STATUS();
                    String routeName = debtor.getFDEBTOR_ROUTE_CODE();
                    final String cusCode = debtor.getFDEBTOR_CODE();
...
//                    new SharedPref(getActivity()).setGlobalVal("PrekeyRouteName", routeName);
                    ...
                    if (!routeCode.equals("") || !routeName.equals("")) {
                        String limitFlag = debtor.getFDEBTOR_ADD1();
                        String period = debtor.getFDEBTOR_ADD2();

 ...
 */
public class CustomKeypadDialogReceipt extends Dialog {
...
//    }
    ...
    public CustomKeypadDialogReceipt(Context context, boolean showPointFive, IOnOkClickListener okClickListener) {
        super(context, true, null);
//        this.context = context;

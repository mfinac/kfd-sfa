...
public class Control {
    ...
    private String FCONTROL_DOWNLOAD_TITLE;
    private String FCONTROL_DOWNLOADCOUNT;
    private String FCONTROL_DOWNLOADEDCOUNT;
    ...
    public String getFCONTROL_DOWNLOAD_TITLE() {
        return FCONTROL_DOWNLOAD_TITLE;
    }

    public void setFCONTROL_DOWNLOAD_TITLE(String FCONTROL_DOWNLOAD_TITLE) {
        this.FCONTROL_DOWNLOAD_TITLE = FCONTROL_DOWNLOAD_TITLE;
    }

    public String getFCONTROL_DOWNLOADCOUNT() {
        return FCONTROL_DOWNLOADCOUNT;
    }

    public void setFCONTROL_DOWNLOADCOUNT(String FCONTROL_DOWNLOADCOUNT) {
        this.FCONTROL_DOWNLOADCOUNT = FCONTROL_DOWNLOADCOUNT;
    }

    public String getFCONTROL_DOWNLOADEDCOUNT() {
        return FCONTROL_DOWNLOADEDCOUNT;
    }

    public void setFCONTROL_DOWNLOADEDCOUNT(String FCONTROL_DOWNLOADEDCOUNT) {
        this.FCONTROL_DOWNLOADEDCOUNT = FCONTROL_DOWNLOADEDCOUNT;
    }
    ...
    public static Control parseControlDetails(JSONObject instance) throws JSONException, NumberFormatException {
        ...
        if(instance != null) {
               ...
               // ctrl.setFCONTROL_COM_REGNO(instance.getString("comRegNo").trim());
                ...
                ctrl.setFCONTROL_INTEGSEQNO(instance.getString("integSeqNo").trim());

...
public class ReceiptHed {
	...
	private String FPRECHED_STATUS;
	...
	public void setSALEREP_DEALCODE(String SALEREP_DEALCODE) {
		this.SALEREP_DEALCODE = SALEREP_DEALCODE;
	}
	...
	public void setSALEREP_AREACODE(String SALEREP_AREACODE) {
		this.SALEREP_AREACODE = SALEREP_AREACODE;
	}
	...
	public String getFPRECHED_STATUS() {
		return FPRECHED_STATUS;
	}

	public void setFPRECHED_STATUS(String FPRECHED_STATUS) {
		this.FPRECHED_STATUS = FPRECHED_STATUS;
	}
...
//	}
	...
	public static ReceiptHed parseReceiptStatus(JSONObject instance) throws JSONException {

		if (instance != null) {
			ReceiptHed rec = new ReceiptHed();
			rec.setFPRECHED_REFNO(instance.getString("refNo").trim());
			rec.setFPRECHED_STATUS(instance.getString("orderStatus").trim());

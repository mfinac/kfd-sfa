...
import com.datamation.kfdupgradesfa.model.InvTaxRg;
...
public class InvTaxRGController {
    ...
    public static final String CREATE_FINVTAXRG_TABLE = "CREATE TABLE IF NOT EXISTS " + TABLE_INVTAXRG + " (" + INVTAXRG_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " + ValueHolder.REFNO + " TEXT, " + INVTAXRG_TAXCODE + " TEXT, " + INVTAXRG_RGNO + " TEXT ); ";
            ...
            for (InvDet invDet : list) {
              ...
              //  if (invDet.getFINVDET_TYPE().equals("SA")) {
                    ...
                    for (TaxDet taxDet : taxcodelist) {
                        ...
                        String s = "SELECT * FROM " + TABLE_INVTAXRG + " WHERE " + ValueHolder.REFNO + "='" + invDet.getFINVDET_REFNO() + "' AND " + INVTAXRG_TAXCODE + "='" + taxDet.getTAXCODE() + "'";
    ...
    public int UpdatePreTaxRG(ArrayList<OrderDetail> list) {
        ...
        try {
            ...
            for (OrderDetail invDet : list) {
                ...
                if (invDet.getFORDDET_TYPE().equals("SA")) {

                    ArrayList<TaxDet> taxcodelist = new TaxDetController(context).getTaxInfoByComCode(invDet.getFORDDET_TAX_COM_CODE());

                    for (TaxDet taxDet : taxcodelist) {

                        String s = "SELECT * FROM " + TABLE_INVTAXRG + " WHERE " + ValueHolder.REFNO + "='" + invDet.getFORDDET_REFNO() + "' AND " + INVTAXRG_TAXCODE + "='" + taxDet.getTAXCODE() + "'";
    ...
    public void ClearTable(String RefNo) {
        ...
        try {
            ...
            dB.delete(TABLE_INVTAXRG, ValueHolder.REFNO + "='" + RefNo + "'", null);
        } catch (Exception e) {

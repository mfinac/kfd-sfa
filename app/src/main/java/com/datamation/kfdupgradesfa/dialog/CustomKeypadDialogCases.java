 ...
 */
public class CustomKeypadDialogCases extends Dialog {
...
//    }
    ...
    public CustomKeypadDialogCases(Context context, boolean showPointFive, IOnOkClickListener okClickListener) {
        super(context, true, null);
//        this.context = context;

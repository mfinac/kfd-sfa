...
import com.datamation.kfdupgradesfa.model.InvTaxDt;
...
public class InvTaxDTController {
    ...
    public void ClearTable(String RefNo) {
        ...
        try {
            ...
            dB.delete(TABLE_INVTAXDT, ValueHolder.REFNO + "='" + RefNo + "'", null);
        } catch (Exception e) {

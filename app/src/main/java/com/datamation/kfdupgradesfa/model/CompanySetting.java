...
public class CompanySetting {
    ...
    public static CompanySetting parseSettings(JSONObject instance) throws JSONException {
        ...
        if (instance != null) {
            ...
            setting.setFCOMPANYSETTING_CHAR_VAL(instance.getString("cCharVal").trim());
            setting.setFCOMPANYSETTING_COMPANY_CODE(instance.getString("cCompanyCode").trim());
            setting.setFCOMPANYSETTING_LOCATION_CHAR(instance.getString("cLocationChar").trim());
            setting.setFCOMPANYSETTING_REMARKS(instance.getString("cRemarks").trim());
            setting.setFCOMPANYSETTING_GRP(instance.getString("cSettingGrp").trim());
            setting.setFCOMPANYSETTING_SETTINGS_CODE(instance.getString("cSettingsCode").trim());
            setting.setFCOMPANYSETTING_NUM_VAL(instance.getString("nNumVal").trim());
            setting.setFCOMPANYSETTING_TYPE(instance.getString("nType").trim());
            return setting;
        }

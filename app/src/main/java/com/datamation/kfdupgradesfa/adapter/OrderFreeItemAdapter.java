...
public class OrderFreeItemAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.Itemcode.setText(orderDet.getFORDDET_ITEM_CODE());
        viewHolder.Itemname.setText(new ItemController(context).getItemNameByCode(orderDet.getFORDDET_ITEM_CODE()));
        viewHolder.Qty.setText(orderDet.getFORDDET_QTY());

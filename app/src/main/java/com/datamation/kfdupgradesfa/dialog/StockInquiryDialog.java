...
import com.datamation.kfdupgradesfa.adapter.StockInquiryAdaptor;
...
public class StockInquiryDialog
{
    ...
    ListView lvStockData,lvGStockData1;
    String LocCode = "";
    ArrayList<StockInfo> arrayList;
    TextView txtTotQty;
    Spinner spn_stock_type;
    SearchView lvSearchData;
    ...
    public StockInquiryDialog(final Context context) {
        ...
        lvSearchData = (SearchView) view.findViewById(R.id.search);
...
//        });
        ...
        lvSearchData.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            @Override
...
//        ListExpandHelper.getListViewSize(lvGStockData);
    ...
    class LoadStockData extends AsyncTask<String, String, String> {
        ...
        public LoadStockData(String item) {
            this.item = item;
        }
...
//            progressDialog.show();
        ...
        protected String doInBackground(String... params) {
            ...
            arrayList = new ItemController(context).getStocks(item);

...
public class FinvDetL3 {
	...
	public static FinvDetL3 parseInvoiceDets(JSONObject jObject) throws JSONException {
		...
		if (jObject != null) {
			...
			finvDetL3.setFINVDETL3_AMT(jObject.getString("amt").trim());
			finvDetL3.setFINVDETL3_ITEM_CODE(jObject.getString("itemcode").trim());
			finvDetL3.setFINVDETL3_QTY(jObject.getString("qty").trim());
			finvDetL3.setFINVDETL3_REF_NO(jObject.getString("refNo").trim());
			finvDetL3.setFINVDETL3_SEQ_NO(jObject.getString("seqNo").trim());
			finvDetL3.setFINVDETL3_TAX_AMT(jObject.getString("taxAmt").trim());
			finvDetL3.setFINVDETL3_TAX_COM_CODE(jObject.getString("taxComCode").trim());
			finvDetL3.setFINVDETL3_TXN_DATE(jObject.getString("txnDate").trim());

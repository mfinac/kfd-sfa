...
public class DayNPrdHed implements Serializable
{
    ...
    private String NONPRDHED_STARTTIME;
    private String NONPRDHED_ENDTIME;
    ...
    public String getNONPRDHED_STARTTIME() {
        return NONPRDHED_STARTTIME;
    }

    public void setNONPRDHED_STARTTIME(String NONPRDHED_STARTTIME) {
        this.NONPRDHED_STARTTIME = NONPRDHED_STARTTIME;
    }

    public String getNONPRDHED_ENDTIME() {
        return NONPRDHED_ENDTIME;
    }

    public void setNONPRDHED_ENDTIME(String NONPRDHED_ENDTIME) {
        this.NONPRDHED_ENDTIME = NONPRDHED_ENDTIME;
    }

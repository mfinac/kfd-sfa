...
import com.datamation.kfdupgradesfa.adapter.PrintVanSaleItemAdapter;
...
import com.datamation.kfdupgradesfa.helpers.ListExpandHelper;
...
import com.datamation.kfdupgradesfa.model.StkIss;
import com.datamation.kfdupgradesfa.utils.EnglishNumberToWords;
...
//            if(new CustomerController(context).getCustomerVatStatus(debtor.getCusCode()).equals("VAT")) {
            ...
            if(invhed.getFINVHED_VAT_CODE().equals("VAT")) {
                ...
                Remarks.setText(salRep.getFREP_CODE() + "/ " + salRep.getFREP_NAME());
...
//                        }
    ...
    public void printItems(String print_loc) {
        ...
        SalRep salrep = new SalRepController(context).getSaleRepDet(new SalRepController(context).getCurrentRepCode());
...
//        else
            subTitleheadR = "" + salRep.getFREP_CODE() + "/ " + salRep.getFREP_NAME();
            String routecode = new RouteDetController(context).getRouteCodeByDebCode(debtor.getCusCode());

...
import com.datamation.kfdupgradesfa.model.Import;
    ...
    public void importDB(String name) {
        try {
            ...
            if (sd.canWrite()) {
             ...
             //   String backupDBPath ="//KFD NEW//"+name; // From SD directory.
...
//                    String backupDBPath = "//KFD SFA//backupname_"+dateFormat.format(date).toString()+".db"; // From SD directory.
...
////                File sd = new File(Environment.getExternalStoragePublicDirectory
////                        (Environment.DIRECTORY_DOCUMENTS), APP_NAME);
//                File sd = new File(Environment.getExternalStorageDirectory() + "/" + APP_NAME);
//                File data = Environment.getDataDirectory();
//
//                if (sd.canWrite()) {
//                    String currentDBPath = "//data//" + PACKAGE_NAME

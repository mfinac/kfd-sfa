...
public class ReceiptSummaryAdapter extends ArrayAdapter<FddbNote> {
    Context context;
    ...
    public ReceiptSummaryAdapter(Context context, ArrayList<FddbNote> list, boolean isSummery, String RefNo) {

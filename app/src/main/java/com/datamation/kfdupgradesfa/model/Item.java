...
public class Item {
	...
	private String FITEM_GENERIC_NM;

	@SerializedName("SupCode")
	private String FITEM_SUPCODE;
	...
	public String getFITEM_SUPCODE() {
		return FITEM_SUPCODE;
	}

	public void setFITEM_SUPCODE(String FITEM_SUPCODE) {
		this.FITEM_SUPCODE = FITEM_SUPCODE;
	}

	public String getFITEM_GENERIC_NM() {
		return FITEM_GENERIC_NM;
	}

	public void setFITEM_GENERIC_NM(String FITEM_GENERIC_NM) {
		this.FITEM_GENERIC_NM = FITEM_GENERIC_NM;
	}
	...
	public static Item parseItem(JSONObject instance) throws JSONException {
		...
		if (instance != null) {
			...
			itm.setFITEM_SUPCODE(instance.getString("supCode").trim());
			itm.setFITEM_GENERIC_NM(instance.getString("genericName").trim());

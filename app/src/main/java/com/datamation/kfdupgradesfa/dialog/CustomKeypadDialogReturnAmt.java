 ...
 */
public class CustomKeypadDialogReturnAmt extends Dialog {
...
//    }
    ...
    public CustomKeypadDialogReturnAmt(Context context, boolean showPointFive, IOnOkClickListener okClickListener) {
        super(context, true, null);
//        this.context = context;
